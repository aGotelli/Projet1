...
public:
 ...
 inline const int& XLines() const {return xTiles; } //  WRONG RETURN ELEMENT
 inline const int& YLines() const {return yTIles; } //  WRONG RETURN ELEMENT

private:
  //  NOT CLEAR THAT IT IS THE NUMBER OF LINES
 const int xLines { 4 };
 const int yLines { 4 };
